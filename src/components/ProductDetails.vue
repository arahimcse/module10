...
<template>
  <article class="w-full flex flex-col justify-center items-center">
    <!-- Thumbnail  -->
    <div
      class="image-thumbnail w-[70%] mx-[15%] my-10 flex flex-col justify-center items-center"
    >
      <img :src="viewThumbnail" :alt="product.title" />
      <div
        class="flex flex-col justify-center items-center mt-[25px] text-lg text-[#666]"
      >
        <p>{{ product.title }}</p>
    ...
    <div class="image-list w-[50%] flex flex-row justify-center items-center">
      <button
        class="p-[5px] mx-[5px] border-[1px] border-orange-400 h-[60px]"
    ...
    <!-- Product Description -->
    <div
      class="product-description flex flex-col w-[50%] justify-center items-center py-[25px]"
    >
    ...
    <div
      class="social-icon flex flex-col w-[50%] justify-center items-center py-[25px]"
    >
